...
export default function EmployeeInventory() {
  ...
  const updateStock = useMutation({
    mutationFn: ({ id, stockQty }: { id: string; stockQty: number }) =>
      api.patch(`/products/admin/${id}/stock`, { stockQty }),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['employee', 'products'] }); toast.success('Stock updated'); },
            ...
            {isLoading ? (
              ...
              <tr key={product.id} className="border-b border-border hover:bg-gray-50">
                ...
                <td className="py-2 text-center">
                  ...
                  ) : product.stockQty <= (product.lowStockThreshold || 10) ? (
                ...
                <td className="py-2 text-right">
                  <input
                    ...
                    onBlur={(e) => {
                      ...
                      if (!isNaN(v) && v >= 0) updateStock.mutate({ id: product.id, stockQty: v });
                    }}
